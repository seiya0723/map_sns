    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='map/place/photo', verbose_name='写真')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(max_length=500, verbose_name='コメント')),
                ('place', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='map.place', verbose_name='プレイス')),
            ],
        ),
    ]
